            ...
            <div class="row">
               <div class="col-md-3">
				...
				<div class="col-md-9" id="mainDiv">
					<h3>
						<i class="icon-user color"></i> &nbsp;Add DeliveryMan
					</h3>

					<form:form class="form-horizontal" method="post"
						action="addDeliveryManForm.html">

						<div class="form-group">
							<form:label class="col-md-2 control-label" path="name">First Name</form:label>
							<div class="col-md-4">
								<form:input class="form-control" path="name" />
							</div>
						</div>
						<div class="form-group">
							<form:label class="col-md-2 control-label" path="surname">Last Name</form:label>
							<div class="col-md-4">
								<form:input class="form-control" path="surname" />
							</div>
						</div>
						<div class="form-group">
							<form:label class="col-md-2 control-label" path="phoneNumber">PhoneNumber</form:label>
							<div class="col-md-4">
								<form:input class="form-control" path="phoneNumber" />
							</div>
						</div>
						<div class="form-group">
							<form:label class="col-md-2 control-label" path="username">Username</form:label>
							<div class="col-md-4">
							<form:input class="form-control" path="username" />
						</div>
						</div>
						<div class="form-group">
							<form:label class="col-md-2 control-label" path="hashPasswd">Password</form:label>
							<div class="col-md-4">
							<form:input class="form-control" path="hashPasswd" />
						</div>
						</div>
						<hr />
						<div class="form-group">
							<div class="col-md-offset-2 col-md-10">
								<button type="submit" class="btn btn-danger">Add DeliveryMan</button>
							</div>
						</div>
					</form:form>
