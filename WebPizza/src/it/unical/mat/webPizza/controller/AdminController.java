...
public class AdminController {
	...
	public @ResponseBody String adminIngredients(Model model,SessionStatus sessionStatus) {
		if(!model.containsAttribute("admin")){			
			return "redirect:adminLogin.html";
		}
	...
	public @ResponseBody String adminAddIngredients(@RequestParam(value="Name") String name,
	...
	public @ResponseBody String admiModifyIngredients(@RequestParam(value="Data") String data,
										Model model) {
